...
func main() {
	// 创建使用LRU-K策略的缓存组
	cacheGroup := geecache.NewGroupWithOptions(
		"test-group",
		1024*1024, // 1MB 缓存
		geecache.GetterFunc(getData),
		60,        // 默认TTL 60秒
		geecache.StrategyLRUK,
		2,         // K=2
	)
